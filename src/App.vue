            ...
            <button @click="openMenu = !openMenu" :class="openMenu ? 'bg-[#282828]' : 'bg-black'"
                ...
                <div class="flex items-center">
                    <img 
                      class="rounded-full" 
                      width="27"
                      src="https://yt3.ggpht.com/yti/ANjgQV8mlRnMYQIYUi7kI33WPbbDyt4hGB9sfu3_lg=s88-c-k-c0x00ffffff-no-rj"
                    >
                    <div class="text-white text-[14px] ml-1.5 font-semibold">Tarik</div>
